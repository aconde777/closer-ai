        ...
        return function() {
          var e = { 7: function(e2) {
            ...
            function u(e3, t3, n3, r2) {
              var i2, o2, a2, u2;
              if (s(n3), void 0 === (o2 = e3._events) ? (o2 = e3._events = /* @__PURE__ */ Object.create(null), e3._eventsCount = 0) : (void 0 !== o2.newListener && (e3.emit("newListener", t3, n3.listener ? n3.listener : n3), o2 = e3._events), a2 = o2[t3]), void 0 === a2)
                a2 = o2[t3] = n3, ++e3._eventsCount;
            ...
            function v(e3, t3, n3, r2) {
              if ("function" == typeof e3.on)
                r2.once ? e3.once(t3, n3) : e3.on(t3, n3);
              else {
            ...
            Object.defineProperty(o, "defaultMaxListeners", { enumerable: true, get: function() {
              ...
              var n3, r2, i2, o2, a2;
              if (s(t3), void 0 === (r2 = this._events))
                return this;
              if (void 0 === (n3 = r2[e3]))
                return this;
              if (n3 === t3 || n3.listener === t3)
                0 == --this._eventsCount ? this._events = /* @__PURE__ */ Object.create(null) : (delete r2[e3], r2.removeListener && this.emit("removeListener", e3, n3.listener || t3));
            ...
            e2.exports = function(e3) {
              ...
              return n2.m = e3, n2.c = t2, n2.d = function(e4, t3, r) {
                ...
                if (n2.r(r), Object.defineProperty(r, "default", { enumerable: true, value: e4 }), 2 & t3 && "string" != typeof e4)
                  for (var i in e4)
              ...
              var r = n2(18), i = function() {
                ...
                return e4.getFirstMatch = function(e5, t3) {
                  ...
                  for (var t3, n3, r2 = e5, i2 = arguments.length, o = new Array(i2 > 1 ? i2 - 1 : 0), a = 1; a < i2; a++)
                    o[a - 1] = arguments[a];
                  if (Object.assign)
                    return Object.assign.apply(Object, [e5].concat(o));
                  var s = function() {
                    var e6 = o[t3];
              ...
              var u = function() {
                ...
                return t3.getUA = function() {
                  ...
                  if ("string" == typeof i2)
                    return ">" === e5[0] || "<" === e5[0] ? (n3 = e5.substr(1), "=" === e5[1] ? (r2 = true, n3 = e5.substr(2)) : t4 = [], ">" === e5[0] ? t4.push(1) : t4.push(-1)) : "=" === e5[0] ? n3 = e5.substr(1) : "~" === e5[0] && (r2 = true, n3 = e5.substr(1)), t4.indexOf(s.default.compareVersions(i2, n3, r2)) > -1;
                }, t3.isOS = function(e5) {
            ...
            function r(e3, t3) {
              ...
              if (Object.getOwnPropertySymbols) {
                ...
                for (r2 = 0; r2 < o2.length; r2++)
                  n3 = o2[r2], -1 === t3.indexOf(n3) && {}.propertyIsEnumerable.call(e3, n3) && (i2[n3] = e3[n3]);
              }
              return i2;
            }
            function i(e3, t3) {
            ...
            function u(e3, t3) {
              if (t3 && ("object" == o(t3) || "function" == typeof t3))
                return t3;
              if (void 0 !== t3)
            ...
            function g(e3, t3) {
              ...
              for (var n3 = 0, r2 = Array(t3); n3 < t3; n3++)
                r2[n3] = e3[n3];
              return r2;
            }
            function m(e3, t3) {
                ...
                if (null != n3) {
                  ...
                  try {
                    if (o2 = (n3 = n3.call(e4)).next, 0 === t4) {
                      ...
                      for (; !(c2 = (r2 = o2.call(n3)).done) && (s2.push(r2.value), s2.length !== t4); c2 = true)
                        ;
                  } catch (e5) {
                    u2 = true, i2 = e5;
                  } finally {
            ...
            function w(e3, t3) {
              ...
              if (e3 && t3 && (n3 = e3.constructor) === t3.constructor) {
                ...
                if (n3 === Array) {
                  if ((r2 = e3.length) === t3.length)
                    for (; r2-- && w(e3[r2], t3[r2]); )
                      ;
                  return -1 === r2;
                }
                if (n3 === Set) {
                  if (e3.size !== t3.size)
                    return false;
                  for (r2 of e3) {
                    if ((i2 = r2) && "object" == typeof i2 && !(i2 = S(t3, i2)))
                      return false;
                    if (!t3.has(i2))
                      return false;
                  }
                ...
                if (n3 === Map) {
                  if (e3.size !== t3.size)
                    return false;
                  for (r2 of e3) {
                    if ((i2 = r2[0]) && "object" == typeof i2 && !(i2 = S(t3, i2)))
                      return false;
                    if (!w(r2[1], t3.get(i2)))
                      return false;
                  }
                ...
                if (n3 === ArrayBuffer)
                  ...
                  if ((r2 = e3.byteLength) === t3.byteLength)
                    for (; r2-- && e3.getInt8(r2) === t3.getInt8(r2); )
                      ;
                  return -1 === r2;
                }
                ...
                if (!n3 || "object" == typeof e3) {
                  for (n3 in r2 = 0, e3) {
                    if (b.call(e3, n3) && ++r2 && !b.call(t3, n3))
                      return false;
                    if (!(n3 in t3) || !w(e3[n3], t3[n3]))
                      return false;
                  }
            ...
            function B(e3, t3, n3) {
              if (n3[t3.name])
                P && F.log(`Integration skipped because it was already installed: ${t3.name}`);
              else {
            ...
            function ne(e3, t3 = {}) {
              ...
              try {
                ...
                for (; n3 && o2++ < r2 && (u2 = re(n3, l2), !("html" === u2 || o2 > 1 && a2 + i2.length * c2 + u2.length >= d2)); )
                  i2.push(u2), a2 += u2.length, n3 = n3.parentNode;
            ...
            function de(e3) {
              if (Y(e3))
                return { message: e3.message, name: e3.name, stack: e3.stack, ...pe(e3) };
              if (Q(e3)) {
            ...
            function ve(e3, t3) {
              if (function(e4) {
                ...
                for (const n4 of Object.getOwnPropertyNames(e3))
                  void 0 !== e3[n4] && (r2[n4] = ve(e3[n4], t3));
                return r2;
              }
              if (Array.isArray(e3)) {
                const n3 = t3.get(e3);
...
Url: ${Ee(e4)}`), true);
            ...
            function De(e3, t3, n3 = 2) {
              ...
              const r2 = { ...e3 };
              for (const e4 in t3)
                Object.prototype.hasOwnProperty.call(t3, e4) && (r2[e4] = De(r2[e4], t3[e4], n3 - 1));
              return r2;
            }
            (() => {
              const { performance: e3 } = D;
            ...
            class xe {
              ...
              captureException(e3, t3) {
                ...
                if (!this._client)
                  return F.warn("No client configured on scope - will not capture exception!"), n3;
              ...
              captureMessage(e3, t3, n3) {
                ...
                if (!this._client)
                  return F.warn("No client configured on scope - will not capture message!"), r2;
              ...
              return { name: "Dedupe", processEvent(t3) {
                ...
                try {
                  if (function(e4, t4) {
                    ...
                    return P && F.warn("Event dropped due to being a duplicate of previously captured event."), null;
                } catch (e4) {
                }
                return e3 = t3;
              } };
            ...
            function at(e3, t3) {
              ...
              if (n3 && !r2 || !n3 && r2)
                return false;
              if (r2.length !== n3.length)
                return false;
              for (let e4 = 0; e4 < r2.length; e4++) {
                const t4 = r2[e4], i2 = n3[e4];
                if (t4.filename !== i2.filename || t4.lineno !== i2.lineno || t4.colno !== i2.colno || t4.function !== i2.function)
                  return false;
              }
              return true;
            }
...
Error:`, t4);
              ...
              return (n3) => {
                ...
                (function(e4) {
                  if (e4.type !== gt)
                    return false;
                  try {
                    if (!e4.target || e4.target._sentryId !== mt)
                      return false;
                  } catch (e5) {
                  }
                  return true;
            ...
            function Tt() {
              ...
              ht.onpopstate = function(...t4) {
                ...
                if (kt = n3, pt("history", { from: r2, to: n3 }), e3)
                  try {
            ...
            function Ot(e3, t3 = false) {
              t3 && !function() {
                ...
                if (t4 && "function" == typeof t4.createElement)
                  try {
            ...
            function zt(e3, t3, n3 = 1 / 0, r2 = 1 / 0, i2 = /* @__PURE__ */ function() {
              ...
              const s2 = function(e4, t4) {
                try {
                  ...
                  if (ee(t4))
                    return "[VueViewModel]";
                  if (K(n4 = t4) && "nativeEvent" in n4 && "preventDefault" in n4 && "stopPropagation" in n4)
                    return "[SyntheticEvent]";
                  if ("number" == typeof t4 && !Number.isFinite(t4))
                    return `[${t4}]`;
                  if ("function" == typeof t4)
                    return `[Function: ${rt(t4)}]`;
                  if ("symbol" == typeof t4)
                    return `[${String(t4)}]`;
                  if ("bigint" == typeof t4)
              ...
              const f2 = de(t3);
              for (const e4 in f2) {
                if (!Object.prototype.hasOwnProperty.call(f2, e4))
                  continue;
                if (d2 >= r2) {
                  l2[e4] = "[MaxProperties ~]";
                  break;
            ...
            function Qt(e3) {
              ...
              if (!t3)
                return;
              const n3 = {};
              for (const [, [e4, r2]] of t3)
                (n3[e4] || (n3[e4] = [])).push(he(r2));
              return n3;
            }
            let Xt = false;
            function Zt(e3) {
            ...
            function sn(e3) {
              ...
              const i2 = n3.spanContext().traceState, o2 = i2 && i2.get("sentry.dsc"), a2 = o2 && function(e4) {
                const t4 = function(e5) {
                  if (e5 && (G(e5) || Array.isArray(e5)))
                    return Array.isArray(e5) ? e5.reduce((e6, t5) => {
                      const n5 = Kt(t5);
              ...
              return { name: "Breadcrumbs", setup(e4) {
                ...
                t3.console && function(e5) {
                  ...
                  return function(t4) {
                    ...
                    if (r2 && (!t4.fetchData.url.match(/sentry_key/) || "POST" !== t4.fetchData.method))
                      if (t4.error)
                        Dt({ category: "fetch", data: t4.fetchData, level: "error", type: "http" }, { data: t4.error, input: t4.args, startTimestamp: n4, endTimestamp: r2 });
                      else {
            ...
            function Vn(e3, t3, n3, r2, i2) {
              ...
              return Y(t3) ? Dn(e3, t3) : K(t3) || Q(t3) ? (o2 = function(e4, t4, n4, r3) {
                ...
                if (a2)
                  return { exception: { values: [Ln(e4, a2)] }, extra: s2 };
            ...
            function Bn(e3, { isUnhandledRejection: t3 }) {
              const n3 = function(e4, t4 = 40) {
                ...
                for (let e5 = n4.length; e5 > 0; e5--) {
                  ...
                  if (!(r4.length > t4))
                    return e5 === n4.length ? r4 : ie(r4, t4);
                }
                return "";
            ...
            function qn(e3, t3, n3 = 250, r2, i2, o2, a2) {
              if (!(o2.exception && o2.exception.values && a2 && Z(a2.originalException, Error)))
                return;
            ...
            function Kn(e3) {
              const t3 = [ke(), Qe(), kn(), Sn(), Jn(), Hn(), ot(), { name: "HttpContext", preprocessEvent(e4) {
                if (!mn.navigator && !mn.location && !mn.document)
                  return;
...
`), "string" == typeof n4 || n4 instanceof Uint8Array)
            ...
            class dr {
              ...
              captureEvent(e3, t3, n3) {
                const r2 = ge();
                if (t3 && t3.originalException && Se(t3.originalException))
                  return P && F.log(lr), r2;
              ...
              _processEvent(e3, t3, n3) {
                ...
                if (a2 && "number" == typeof u2 && Math.random() > u2)
                  return this.recordDroppedEvent("sample_rate", "error", e3), Ut(new ur(`Discarding event because it's not included in the random sample (sampling rate = ${i2})`, "log"));
                ...
                return this._prepareEvent(e3, t3, n3, d2).then((n4) => {
                  if (null === n4)
                    throw this.recordDroppedEvent("event_processor", l2, e3), new ur("An event processor returned `null`, will not send event.", "log");
...
Reason: ${e4}`);
              ...
              _flushOutcomes() {
                ...
                if (!this._dsn)
                  return void (P && F.log("No dsn provided, will not send outcomes"));
            ...
            class hr extends dr {
              ...
              captureUserFeedback(e3) {
                if (!this._isEnabled())
                  return void (Rt && F.warn("SDK not enabled, will not capture user feedback."));
            ...
            function yr(e3, t3, n3 = /* @__PURE__ */ function(e4) {
              ...
              return { $: t4, add: function(r2) {
                if (!(void 0 === e4 || t4.length < e4))
                  return Ut(new ur("Not adding Promise because buffer limit was reached."));
                const i2 = r2();
              ...
              return { send: function(i2) {
                ...
                return n3.add(() => t3({ body: ir(a2) }).then((e4) => (void 0 !== e4.statusCode && (e4.statusCode < 200 || e4.statusCode >= 300) && P && F.warn(`Sentry responded with status code ${e4.statusCode} to sent event.`), r2 = function(e5, { statusCode: t4, headers: n4 }, r3 = Date.now()) {
                  ...
                  if (o3)
                    for (const e6 of o3.trim().split(",")) {
                      const [t5, n5, , , o4] = e6.split(":", 5), a4 = parseInt(t5, 10), s3 = 1e3 * (isNaN(a4) ? 60 : a4);
                      if (n5)
                        for (const e7 of n5.split(";"))
                          "metric_bucket" === e7 && o4 && !o4.split(";").includes("custom") || (i3[e7] = r3 + s3);
                      else
                        i3.all = r3 + s3;
                    }
                  else
                    a3 ? i3.all = r3 + function(e6, t5 = Date.now()) {
                  ...
                  if (e4 instanceof ur)
                    return P && F.error("Skipped sending event because buffer is full."), s2("queue_overflow"), Vt({});
                  throw e4;
                });
            ...
            var ia = function() {
              ...
              return c(e3, [{ key: "isNoOp", value: function() {
                ...
                if (!ra.includes(e4))
                  throw Error("Unrecognized mergeStrategy provided. Options are: [".concat(ra, "]"));
              } }, { key: "_validateData", value: function(e4, t3) {
                if (!function(e5) {
                  if (null == e5 || "object" !== o(e5))
                    return false;
                ...
                try {
                  if (n3 = JSON.stringify(e4), t3 === ta) {
                    ...
                    for (var i2 in e4)
                      if (Object.hasOwnProperty.call(e4, i2) && void 0 !== e4[i2]) {
                ...
                if (n3.length > yo)
                  throw Error("Meeting session data is too large (".concat(n3.length, " characters). Maximum size suppported is ").concat(yo, "."));
              } }]);
            }();
            function oa() {
              try {
            ...
            var ua = function() {
              ...
              return c(function e4(t4, n4, r3) {
                ...
                try {
                  ...
                  if (clearTimeout(this._networkTimeout), t5 instanceof da || this.cancelled || this._networkTimedOut)
                    return;
            ...
            function wa(e3, t3) {
              for (var n3 = t3.getState(), r2 = 0, i2 = ["cam", "screen"]; r2 < i2.length; r2++)
            ...
            var xa = Object.freeze({ VIDEO: "video", AUDIO: "audio", SCREEN_VIDEO: "screenVideo", SCREEN_AUDIO: "screenAudio", CUSTOM_VIDEO: "customVideo", CUSTOM_AUDIO: "customAudio" }), Fa = Object.freeze({ PARTICIPANTS: "participants", STREAMING: "streaming", TRANSCRIPTION: "transcription" }), Va = Object.values(xa), Ua = ["v", "a", "sv", "sa", "cv", "ca"], Ba = (Object.freeze(Va.reduce(function(e3, t3, n3) {
              ...
              return c(e3, [{ key: "clone", value: function() {
                var t3 = new e3();
                if (this.base instanceof qa ? t3.base = this.base.clone() : t3.base = this.base, void 0 !== this.byUserId)
                ...
                if (void 0 !== this.byParticipantId)
                  for (var i2 in t3.byParticipantId = {}, this.byParticipantId) {
                ...
                var e4 = {};
                if ("boolean" == typeof this.base ? e4.base = this.base : this.base instanceof qa && (e4.base = this.base.toJSONObject()), void 0 !== this.byUserId)
                  for (var t3 in e4.byUserId = {}, this.byUserId) {
                    var n3 = this.byUserId[t3];
                    e4.byUserId[t3] = n3 instanceof qa ? n3.toJSONObject() : n3;
                  }
                if (void 0 !== this.byParticipantId)
                  for (var r2 in e4.byParticipantId = {}, this.byParticipantId) {
                ...
                if (void 0 !== this.byParticipantId)
                  for (var r2 in e4.p = {}, this.byParticipantId) {
                    var i2 = this.byParticipantId[r2];
                ...
                var n3, r2, i2;
                if (void 0 !== t3.base && (n3 = "boolean" == typeof t3.base ? t3.base : qa.fromJSONObject(t3.base)), void 0 !== t3.byUserId)
                  for (var o2 in r2 = {}, t3.byUserId) {
                    var a2 = t3.byUserId[o2];
                    r2[o2] = "boolean" == typeof a2 ? a2 : qa.fromJSONObject(a2);
                  }
                if (void 0 !== t3.byParticipantId)
                  for (var s2 in i2 = {}, t3.byParticipantId) {
                ...
                var n3, r2, i2;
                if (void 0 !== t3.b && (n3 = "boolean" == typeof t3.b ? t3.b : qa.fromMinifiedJSONObject(t3.b)), void 0 !== t3.u)
                  for (var o2 in r2 = {}, t3.u) {
                    var a2 = t3.u[o2];
                    r2[o2] = "boolean" == typeof a2 ? a2 : qa.fromMinifiedJSONObject(a2);
                  }
                if (void 0 !== t3.p)
                  for (var s2 in i2 = {}, t3.p) {
                    var c2 = t3.p[s2];
                ...
                for (var t3 = ["base", "byUserId", "byParticipantId"], n3 = 0, r2 = Object.keys(e4); n3 < r2.length; n3++) {
                  ...
                  if ("base" === i2) {
                    ...
                    if ("object" !== o(e4[i2]))
                      return [false, "invalid (non-object) value for field '".concat(i2, "' in canReceive")];
              ...
              return c(e3, [{ key: "clone", value: function() {
                ...
                for (var n3 = Object.keys(e4), r2 = 0, i2 = n3; r2 < i2.length; r2++) {
                  var a2 = i2[r2];
                  if (!Va.includes(a2))
                    return [false, "invalid media type '".concat(a2, "' in canReceive")];
                  if (Ba.includes(a2)) {
                    if ("boolean" != typeof e4[a2])
                      return [false, "invalid (non-boolean) value for media type '".concat(a2, "' in canReceive")];
                  } else {
                    if ("object" !== o(e4[a2]))
                      return [false, "invalid (non-object) value for media type '".concat(a2, "' in canReceive")];
                    for (var s2 = 0, c2 = Object.values(e4[a2]); s2 < c2.length; s2++)
                      if ("boolean" != typeof c2[s2])
                        return [false, "invalid (non-boolean) value for entry within '".concat(a2, "' in canReceive")];
                    if (t3 && void 0 === e4[a2]["*"])
                      return [false, `canReceive "base" permission must specify "*" as an entry within '`.concat(a2, "'")];
                  }
                }
            ...
            var Za = {}, es = "video", ts = "voice", ns = Po() ? { data: {} } : { data: {}, topology: "none" }, rs = { present: 0, hidden: 0 }, is = { maxBitrate: { min: 1e5, max: 25e5 }, maxFramerate: { min: 1, max: 30 }, scaleResolutionDownBy: { min: 1, max: 8 } }, os = Object.keys(is), as = ["state", "volume", "simulcastEncodings"], ss = { androidInCallNotification: { title: "string", subtitle: "string", iconName: "string", disableForCustomOverride: "boolean" }, disableAutoDeviceManagement: { audio: "boolean", video: "boolean" } }, cs = { id: { iconPath: "string", iconPathDarkMode: "string", label: "string", tooltip: "string", visualState: "'default' | 'sidebar-open' | 'active'" } }, us = { id: { allow: "string", controlledBy: "'*' | 'owners' | string[]", csp: "string", iconURL: "string", label: "string", loading: "'eager' | 'lazy'", location: "'main' | 'sidebar'", name: "string", referrerPolicy: "string", sandbox: "string", src: "string", srcdoc: "string", shared: "string[] | 'owners' | boolean" } }, ls = { customIntegrations: { validate: js, help: Ds() }, customTrayButtons: { validate: Ns, help: "customTrayButtons should be a dictionary of the type ".concat(JSON.stringify(cs)) }, url: { validate: function(e3) {
              ...
              if (e3 instanceof MediaStreamTrack)
                t3._sharedTracks.videoTrack = e3, n3 = { customTrack: ko };
              else {
              ...
              var n3;
              if (e3 instanceof MediaStreamTrack)
                t3._sharedTracks.audioTrack = e3, n3 = { customTrack: ko };
              else {
              ...
              var t3 = ["accent", "accentText", "background", "backgroundAccent", "baseText", "border", "mainAreaBg", "mainAreaBgAccent", "mainAreaText", "supportiveText"], n3 = function(e4) {
                for (var n4 = 0, r2 = Object.keys(e4); n4 < r2.length; n4++) {
                  ...
                  if (!e4[i2].match(/^#[0-9a-f]{6}|#[0-9a-f]{3}$/i))
                    return console.error("".concat(i2, ' theme color should be provided in valid hex color format. Received: "').concat(e4[i2], '"')), false;
                }
                return true;
              };
              ...
              if (n3.includes(e3) || !Po() && "avatar" === e3)
                return true;
              var r2 = ["audio", "video", "screenAudio", "screenVideo", "rmpAudio", "rmpVideo"], i2 = function(e4) {
                ...
                for (var o2 in e4)
                  if ("custom" === o2) {
                    if (!n3.includes(e4[o2]) && !i2(e4[o2], true))
                      return false;
                  } else {
            ...
            var fs = function(e3) {
              function t3(e4) {
                ...
                if (i(this, t3), o2 = this, a3 = l(a3 = t3), p(r2 = u(o2, Ka() ? Reflect.construct(a3, [], l(o2).constructor) : a3.apply(o2, s3)), "startListeningForDeviceChanges", function() {
                  ...
                  var e5 = v(function* (e6) {
                    if ("destroyed" === e6)
                      return console.warn("App has been destroyed before leaving the meeting. Cleaning up all the resources!"), void (yield r2.destroy());
                    var t4 = "active" === e6;
              ...
              return f(t3, e3), c(t3, [{ key: "destroy", value: (te2 = v(function* () {
                ...
                for (var n4 in t4) {
                  ...
                  if (ds[n4].validate && !ds[n4].validate(t4[n4], this, this._participants[e4]))
                    throw new Error(ds[n4].help);
                }
                ...
                if (bs(this._callObjectMode, "updateWaitingParticipant()"), vs(this._callState, "updateWaitingParticipant()"), "string" != typeof t4 || "object" !== o(n4))
                ...
                if (bs(this._callObjectMode, "updateWaitingParticipants()"), vs(this._callState, "updateWaitingParticipants()"), "object" !== o(t4))
                ...
                if (bs(this._callObjectMode, "getReceiveSettings()"), !this._callMachineInitialized)
                ...
                var t4 = this;
                if (bs(this._callObjectMode, "updateReceiveSettings()"), !Ts(e4, { allowAllParticipantsKey: true }))
                  throw new Error(Ls({ allowAllParticipantsKey: true }));
                ...
                return ws(), Ms(e4) ? e4.video || e4.audio ? (As(e4, this.properties.dailyConfig, this._sharedTracks), this._callObjectMode && !this._callMachineInitialized ? (this._updatePreloadCacheInputSettings(e4, true), this._getInputSettings()) : new Promise(function(n4, r2) {
                  t4.sendMessageToCallMachine({ action: "update-input-settings", inputSettings: e4 }, function(i2) {
                    if (i2.error)
                      ...
                      if (i2.returnPreloadCache)
                        return t4._updatePreloadCacheInputSettings(e4, true), void n4(t4._getInputSettings());
                ...
                if (ws(), this._callMachineInitialized)
                  return this.sendMessageToCallMachine({ action: "set-bandwidth", kbs: t4, trackConstraints: n4 }), this;
                ...
                if (this.validateAudioLevelInterval(e4), this._callMachineInitialized)
                  return this._isLocalAudioLevelObserverRunning = true, new Promise(function(n4, r2) {
                ...
                var t4 = this;
                if (this.validateAudioLevelInterval(e4), this._callMachineInitialized)
                  return this._isRemoteParticipantsAudioLevelObserverRunning = true, new Promise(function(n4, r2) {
                ...
                var e4 = this, t4 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                if (bs(this._callObjectMode, "startCamera()"), ms(this._callState, this._isPreparingToJoin, "startCamera()", "Did you mean to use setLocalAudio() and/or setLocalVideo() instead?"), this.needsLoad())
                  try {
                    yield this.load(t4);
                  } catch (e5) {
                ...
                if (n4 && ["cam-audio", "cam-video", "screen-video", "screen-audio", "rmpAudio", "rmpVideo", "customVideoDefaults"].includes(n4))
                ...
                if (ws(), void 0 !== i2 && (n4 = i2), void 0 !== o2 && (r2 = o2), "boolean" == typeof n4 && (this._setAllowLocalAudio(n4), n4 = void 0), "boolean" == typeof r2 && (this._setAllowLocalVideo(r2), r2 = void 0), !n4 && !r2)
                ...
                return n4 && (n4 instanceof MediaStreamTrack ? (this._sharedTracks.audioTrack = n4, n4 = ko, a3.audio = { settings: { customTrack: n4 } }) : (delete this._sharedTracks.audioTrack, a3.audio = { settings: { deviceId: n4 } })), r2 && (r2 instanceof MediaStreamTrack ? (this._sharedTracks.videoTrack = r2, r2 = ko, a3.video = { settings: { customTrack: r2 } }) : (delete this._sharedTracks.videoTrack, a3.video = { settings: { deviceId: r2 } })), this._callObjectMode && this.needsLoad() ? (this._updatePreloadCacheInputSettings(a3, false), this._devicesFromInputSettings(this._inputSettings)) : new Promise(function(e5) {
                  t4.sendMessageToCallMachine({ action: "set-input-devices", audioDeviceId: n4, videoDeviceId: r2 }, function(n5) {
                    if (delete n5.action, delete n5.callbackStamp, n5.returnPreloadCache)
                      return t4._updatePreloadCacheInputSettings(a3, false), void e5(t4._devicesFromInputSettings(t4._inputSettings));
                    e5(n5);
                  });
                });
              }), function(e4) {
                ...
                if (ks(), [es, ts].includes(e4)) {
                  if (e4 !== this._nativeInCallAudioMode)
                    return this._nativeInCallAudioMode = e4, !this.disableReactNativeAutoDeviceManagement("audio") && gs(this._callState, this._isPreparingToJoin) && this.nativeUtils().setAudioMode(this._nativeInCallAudioMode), this;
                } else
                  console.error("invalid in-call audio mode specified: ", e4);
              } }, { key: "preAuth", value: (B2 = v(function* () {
                var e4 = this, t4 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                if (bs(this._callObjectMode, "preAuth()"), ms(this._callState, this._isPreparingToJoin, "preAuth()"), this.needsLoad() && (yield this.load(t4)), !t4.url)
                ...
                if (this.needsLoad()) {
                  ...
                  if (e4 && (this.validateProperties(e4), this.properties = Ha(Ha({}, this.properties), e4)), !this._callObjectMode && !this.properties.url)
                ...
                if (ys(this._callMachineInitialized, "startScreenShare()"), t4.screenVideoSendSettings && this._validateVideoSendSettings("screenVideo", t4.screenVideoSendSettings), t4.mediaStream && (this._sharedTracks.screenMediaStream = t4.mediaStream, t4.mediaStream = ko), "undefined" != typeof DailyNativeUtils && void 0 !== DailyNativeUtils.isIOS && DailyNativeUtils.isIOS) {
                  ...
                  if (yield n4.isScreenBeingCaptured())
                  ...
                  this.sendMessageToCallMachine({ action: bo, captureOptions: t4 });
              }), function() {
                return x2.apply(this, arguments);
                ...
                if (t4 && "cloud" !== t4 && "raw-tracks" !== t4 && "local" !== t4)
                  throw new Error("invalid type: ".concat(t4, ", allowed values 'cloud', 'raw-tracks', or 'local'"));
                ...
                if (e4) {
                  ...
                  for (var r2 = 0; r2 < e4.length; r2++) {
                    var i2 = e4[r2];
                    for (var o2 in this._validateEncodingLayerHasValidProperties(i2), i2)
                      if (os.includes(o2)) {
                        if ("number" != typeof i2[o2])
                        ...
                        throw new Error("Invalid key ".concat(o2, ", valid keys are:") + Object.values(os));
                    if (n4 && !i2.hasOwnProperty("maxBitrate"))
                ...
                try {
                  !function(e5) {
                    ...
                    for (var t5 in e5)
                      if (!as.includes(t5))
                        throw new Error("Invalid key ".concat(t5, ", valid keys are: ").concat(as));
                ...
                if (vs(this._callState, "updateTranscription()"), !e4)
                ...
                if (vs(this._callState, "stopTranscription()"), e4 && "object" !== o(e4))
                ...
                if (e4.provider) {
                  if ("daily" !== e4.provider)
                    throw new Error("Error: provider can be set only to 'daily', got: ".concat(e4.provider));
                  if (e4.phoneNumber)
                ...
                var t4 = this;
                if (vs(this._callState, "sipCallTransfer()"), !e4)
                ...
                var t4 = this;
                if (vs(this._callState, "sipRefer()"), !e4)
                ...
                return vs(this._callState, "sendDTMF()"), function(e5) {
                  ...
                  if ("string" != typeof t5 || "string" != typeof n4)
                  ...
                  if (r2 && r2[0])
                    throw new Error("".concat(r2[0], " is not valid DTMF tone"));
                ...
                var e4 = this;
                if (_s(this._testCallInProgress, "testWebsocketConnectivity()"), this.needsLoad())
                  try {
                    yield this.load();
                  } catch (e5) {
                    return Promise.reject(e5);
                ...
                var t4 = this;
                if (_s(this._testCallInProgress, "testPeerToPeerCallQuality()"), this.needsLoad())
                  try {
                    yield this.load();
                  } catch (e5) {
                    return Promise.reject(e5);
                ...
                if (!this._validateVideoTrackForNetworkTests(n4))
                ...
                var t4 = this;
                if (_s(this._testCallInProgress, "testNetworkConnectivity()"), this.needsLoad())
                  try {
                    yield this.load();
                  } catch (e5) {
                    return Promise.reject(e5);
                ...
                var t4;
                if (!((null === (t4 = Object.keys(e4)) || void 0 === t4 ? void 0 : t4.length) > 0))
                  throw new Error("Empty encoding is not allowed. At least one of these valid keys should be specified:" + Object.values(os));
                ...
                if ("string" == typeof t4) {
                  ...
                  if ("object" !== o(t4))
                    throw new Error(r2);
                  if (!t4.maxQuality && !t4.encodings && void 0 === t4.allowAdaptiveLayers)
                    throw new Error("Video send settings must contain at least maxQuality, allowAdaptiveLayers or encodings attribute");
                  if (t4.maxQuality && -1 === ["low", "medium", "high"].indexOf(t4.maxQuality))
                ...
                var t4 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "*";
                if (vs(this._callState, "sendAppMessage()"), JSON.stringify(e4).length > this._maxAppMessageSize)
                ...
                if (ws(), this._iframe && !document.fullscreenElement && Lo())
                  try {
                ...
                if (ws(), "number" != typeof e4 && true !== e4 && false !== e4)
                ...
                for (var u2 in e4)
                  if (ls[u2]) {
                    if (ls[u2].validate && !ls[u2].validate(e4[u2], this))
                      throw new Error("property '".concat(u2, "': ").concat(ls[u2].help));
                  } else
                    console.warn("Ignoring unrecognized property '".concat(u2, "'")), delete e4[u2];
                ...
                if (null !== (n4 = e4.error) && void 0 !== n4 && n4.type) {
                  if (![ri, ti, Zr].includes(e4.error.type))
                    return;
                  if (e4.error.type === Zr && e4.error.msg.includes("deleted"))
                    return;
                }
                ...
                if (ws(), !e4 || !e4.contentWindow || "string" != typeof e4.src)
            ...
            function hs(e3, t3) {
              var n3 = {};
              for (var r2 in e3)
                if (e3[r2] instanceof MediaStreamTrack)
                  console.warn("MediaStreamTrack found in props or cache.", r2), n3[r2] = ko;
            ...
            function Os(e3) {
              ...
              if ("object" !== o(e3))
                return false;
              if ("string" != typeof (t3 = e3.type) || !Object.values(Eo).includes(t3) && (console.error("inputSettings video processor type invalid"), 1))
                return false;
              if (e3.config) {
                if ("object" !== o(e3.config))
                  return false;
                if (!function(e4, t4) {
            ...
            function Ns(e3) {
              if (e3 && "object" !== o(e3) || Array.isArray(e3))
                return console.error("customTrayButtons should be an Object of the type ".concat(JSON.stringify(cs), ".")), false;
              if (e3)
                for (var t3 = 0, n3 = Object.entries(e3); t3 < n3.length; t3++)
                  for (var r2 = m(n3[t3], 1)[0], i2 = 0, a2 = Object.entries(e3[r2]); i2 < a2.length; i2++) {
                    ...
                    switch (c2) {
                      ...
                      case "iconPathDarkMode":
                        ...
                        break;
                      case "visualState":
                        if (!["default", "sidebar-open", "active"].includes(u2))
                          return console.error("customTrayButton ".concat(c2, " should be ").concat(l2, ". Got: ").concat(u2)), false;
                        break;
                      default:
                        if (o(u2) !== l2)
                          return console.error("customTrayButton ".concat(c2, " should be a ").concat(l2, ".")), false;
                    }
                  }
              return true;
            }
            function js(e3) {
              if (!e3 || e3 && "object" !== o(e3) || Array.isArray(e3))
                return console.error(Ds()), false;
              for (var t3 = function(e4) {
                ...
                var a2 = m(i2[r2], 1)[0];
                if (!("label" in e3[a2]))
                  return n3(a2, "label is required"), false;
                if (!("location" in e3[a2]))
                  return n3(a2, "location is required"), false;
                if (!("src" in e3[a2]) && !("srcdoc" in e3[a2]))
                  return n3(a2, "src or srcdoc is required"), false;
                for (var s2 = 0, c2 = Object.entries(e3[a2]); s2 < c2.length; s2++) {
                  ...
                  switch (l2) {
                    ...
                    case "iconURL":
                      if (!O(d2))
                        return n3(a2, "".concat(l2, " should be a url")), false;
                      break;
                    case "src":
                      if ("srcdoc" in e3[a2])
                        return n3(a2, "cannot have both src and srcdoc"), false;
                      if (!O(d2))
                        return n3(a2, 'src "'.concat(d2, '" is not a valid URL')), false;
                      break;
                    case "srcdoc":
                      if ("src" in e3[a2])
                        return n3(a2, "cannot have both src and srcdoc"), false;
                    ...
                    default:
                      if (!us.id[l2])
                        return console.error("customIntegration does not support key ".concat(l2)), false;
                  }
                }
              }
              return true;
            ...
            function xs(e3, t3) {
              ...
              if ("string" != typeof n3 || "string" != typeof r2)
            ...
            function Fs(e3) {
              ...
              if (e3.state && !Object.values(Mo).includes(e3.state))
                throw new Error("Invalid value for RemoteMediaPlayerSettings.state, valid values are: " + JSON.stringify(Mo));
              if (e3.volume) {
